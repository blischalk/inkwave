...
- **Browse in the tree** — When you open a file or folder, a **file tree** appears on the left. Expand folders (▶/▼) to see subfolders and markdown files. Click any file to view it.

- **Collapse the tree** — Use the **◀** button in the Files header to hide the sidebar for more reading space. Click **▶ Files** on the left edge to bring it back.
